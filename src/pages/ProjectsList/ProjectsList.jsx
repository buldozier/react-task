...
import {setAvailableProjectsAction} from "../../store/availableProjectsReducer";
import {Link} from "react-router-dom";
import "./ProjectsList.scss"

import {mainUrl} from "../../constants/constants";
import MyLoaderSpinner from "../../components/UI/MyLoaderSpinner/MyLoaderSpinner";

const ProjectsList = () => {
    const dispatch = useDispatch()
    const organizations = useSelector(state => state.organizations.organizations)
    const availableProjects = useSelector(state => state.availableProjects.availableProjects)

    const [fetchAvailableProjects, isLoadingFetchAvailableProjects, errorFetchAvailableProjects] = useFetching(async () => {
        const response = await PostService.getAvailableProjects()
        if (response.data.success && response.data.result !== false) {
            dispatch(setAvailableProjectsAction(response.data.result))
        }
    })
    ...
    return (
        <div className='project-list g-hide-scrollbar'>
            <div className='l-wrapper'>
                {!errorFetchAvailableProjects && !isLoadingFetchAvailableProjects &&
                    <div className='project-list__holder'>
                            ...
                            if (typeof project.organization !== 'undefined' && project.organization !== null && project.organization !== '0') {
                                image = projectOrganization !== undefined
                                    ? <img
                                        ...
                                        ////// ДЛЯ РАЗРАБОТКИ
                                        // src={organizations[project.organization].logo.SRC}
                                        alt={projectOrganization.name}
                                    ></img>
                                    : <div className='project-list__item-background-img'></div>
                            }
                            return (
                                <div className='project-list__item' key={project.id}>
                                    <Link to={'/' + project.id + '/'}>
                                        ...
                                        <div className='project-list__item-holder'>
                                            <h3>{project.name}</h3>
                                        </div>
                                    </Link>
                                </div>
                ...
                {isLoadingFetchAvailableProjects &&
                    <div className='project-list__loader'>
                        <MyLoaderSpinner classes={['project-list__loader-svg']}/>
                    </div>
                }
                {errorFetchAvailableProjects &&
                    <div className='project-list__empty'>
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                             id="Capa_1" x="0px" y="0px" width="792px" height="792px" viewBox="0 0 792 792">
                            <g>
                                <g>
                                    <g>
                                        <path
                                            d="M220.146,175.828c6.832,0,12.375,5.543,12.375,12.375s-5.543,12.375-12.375,12.375h-19.568v486.75h390.844v-486.75     h-19.594c-6.832,0-12.375-5.543-12.375-12.375s5.543-12.375,12.375-12.375h31.659h0.31c6.832,0,12.375,5.543,12.375,12.375     v511.189v0.336c0,6.831-5.543,12.375-12.375,12.375H188.512h-0.31c-6.832,0-12.375-5.544-12.375-12.375V188.513v-0.31     c0-6.832,5.543-12.375,12.375-12.375H220.146z"/>
                                        <path
                                            d="M332.062,48.005c6.806,0,12.323,5.517,12.323,12.323c0,6.806-5.517,12.323-12.323,12.323h-35.578v103.177h199.031V72.651     l-35.578-0.025c-6.808,0-12.323-5.518-12.323-12.324c0-6.806,5.517-12.323,12.323-12.323l46.688,0.026l1.265-0.052     c6.832,0,12.375,5.543,12.375,12.375v127.565v0.31c0,6.832-5.543,12.375-12.375,12.375H284.419h-0.31     c-6.832,0-12.375-5.543-12.375-12.375V60.328h0.052c0-6.806,5.517-12.323,12.323-12.323H332.062z"/>
                                        <path
                                        d="M379.989,312.469c-6.832,0-12.375-5.543-12.375-12.375c0-6.832,5.543-12.375,12.375-12.375h159.87     c6.832,0,12.375,5.543,12.375,12.375c0,6.832-5.543,12.375-12.375,12.375H379.989L379.989,312.469z M379.989,600.188     c-6.832,0-12.375-5.543-12.375-12.375c0-6.831,5.543-12.375,12.375-12.375h159.87c6.832,0,12.375,5.544,12.375,12.375     c0,6.832-5.543,12.375-12.375,12.375H379.989L379.989,600.188z M379.989,504.281c-6.832,0-12.375-5.543-12.375-12.375     s5.543-12.375,12.375-12.375h159.87c6.832,0,12.375,5.543,12.375,12.375s-5.543,12.375-12.375,12.375H379.989L379.989,504.281z      M379.989,408.375c-6.832,0-12.375-5.543-12.375-12.375s5.543-12.375,12.375-12.375h159.87c6.832,0,12.375,5.569,12.375,12.375     c0,6.832-5.543,12.375-12.375,12.375H379.989z"/>
                                    <path
